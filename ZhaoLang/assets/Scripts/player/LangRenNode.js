...
cc.Class({
    ...
    init(tab) {
        ...
        this.m_JZJ = PlayerEnum["JZJ_CUNMIN"];     //假职介（狼人才需要用），村民，先知，主动，被动
        this.m_Num = tab.m_Num;     //当前编号
        this.m_showNum = parseInt(this.m_Num) + 1;  //当前号码牌
        this.m_DP = this.m_DP || tab.m_DP;      //底牌  狼神判断也在这里
    ...
    chitchat() {
        switch (this.m_DP) {
            case PlayerEnum["LS_PUTONG"]:
                cc.log("我是狼人" + this.m_showNum + "号");
                break;
            case PlayerEnum["LS_LANGWANG"]:
                cc.log("我是狼王" + this.m_showNum + "号");
                break;
            case PlayerEnum["LS_LANGMEI"]:
                cc.log("我是狼美" + this.m_showNum + "号");
                break;
            case PlayerEnum["LS_KUANGLANG"]:
                cc.log("我是狂狼" + this.m_showNum + "号");
                break;
            case PlayerEnum["LS_DULANG"]:
                cc.log("我是毒狼" + this.m_showNum + "号");
                break;
            default:
                cc.log("我是狼人出错的" + this.m_showNum + "号");
                break;
        }
    },
